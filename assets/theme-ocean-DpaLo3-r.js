...
`;class Ue extends M{constructor(e,n){super(e,n),this.config=Ge,this.modules={},this.maskScene=null,this.maskCamera=null,this.requiresReloadOnResize=!0,this.resizeReloadDelay=500}async init(){try{console.log("Initializing Ocean theme..."),this.modules.sceneSetup=new ae(this.canvas,this.sizes,this.config);const{scene:e,camera:n,renderer:t,cameraGroup:i}=this.modules.sceneSetup.setup();this.scene=e,this.camera=n,this.renderer=t,this.cameraGroup=i,this.maskScene=new F,this.maskCamera=j(this.camera,[],[]),this.maskScene.add(this.maskCamera),console.log("Creating layer system..."),this.modules.layerSystem=new ze(this.scene,this.camera,this.sizes,this.config),await this.modules.layerSystem.createLayers(),this.modules.layerSystem.createStencilMask(this.maskScene),console.log("Creating particle system..."),this.modules.particleSystem=new Oe(this.scene,this.sizes,this.config),await this.modules.particleSystem.init(),console.log("Loading models...");const a=this.modules.particleSystem.getStarGroup();this.modules.modelLoader=new Te(this.scene,a,this.sizes,this.config),await this.modules.modelLoader.init(),console.log("Setting up post-processing..."),this.modules.postProcessing=new Le(this.renderer,this.scene,this.camera,this.maskScene,this.maskCamera,this.config),await this.modules.postProcessing.setup(this.sizes),console.log("Creating animation controller..."),this.modules.animationController=new Fe(this.clock,this.modules,this.sizes,this.config),this.modules.maskCamera=this.maskCamera,this.isInitialized=!0,console.log("Ocean theme initialized successfully!")}catch(e){throw console.error("Failed to initialize Ocean theme:",e),e}}tick(){this.isInitialized&&(this.modules.animationController.update(),this.modules.postProcessing.render())}resize(e){this.sizes=e,this.modules.sceneSetup&&this.modules.sceneSetup.resize(e),this.modules.postProcessing&&this.modules.postProcessing.resize(e),console.log("Ocean theme resized to:",e)}onScroll(e){this.modules.animationController&&this.modules.animationController.handleScroll(e)}onMouseMove(e){this.modules.animationController&&this.modules.animationController.handleMouseMove(e)}async onContentReady(){console.log("Initializing DOM-dependent modules..."),this.modules.timelineRenderer=new Re,await this.modules.timelineRenderer.init("#timeline-container","/themes/ocean/timeline-data.json"),console.log("DOM-dependent modules initialized")}dispose(){console.log("Disposing Ocean theme..."),this.modules.timelineRenderer&&this.modules.timelineRenderer.dispose(),this.modules.postProcessing&&this.modules.postProcessing.dispose(),this.modules.modelLoader&&this.modules.modelLoader.dispose(),this.modules.particleSystem&&this.modules.particleSystem.dispose(),this.modules.layerSystem&&this.modules.layerSystem.dispose(),this.modules.sceneSetup&&this.modules.sceneSetup.dispose(),this.maskScene&&this.maskScene.clear(),this.isInitialized=!1,console.log("Ocean theme disposed")}static getMetadata(){return{id:"ocean",name:"Ocean Parallax",description:"Multi-layer ocean scene with particles, underwater effects, and parallax scrolling",author:"Shu Chen",complexity:"high",htmlContent:je,styles:Ae}}}export{Ue as default};
